...
VAL_FILES=/mnt/cache/wuruixiao/users/lsc/EasyR1/data/offline_rft/isic/v1/MCQ_test_4shot_nothinking.4labels_text.jsonl
...
EXPERIMENT_NAME="4label_text_list_eval3_nothinking_isic_rollout_log"

...
CONFIG=${CONFIG:-Comparative-R1/configs/MCQ.yaml}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-isic_mcq_4shot}
FORMAT_PROMPT=Comparative-R1/prompts/omnimed_isic.jinja
...
python3 -m verl.trainer.main \
  ...
  data.format_prompt=Comparative-R1/prompts/omnimed_isic.jinja 

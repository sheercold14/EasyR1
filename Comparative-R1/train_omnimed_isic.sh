...
TRAIN_FILE=${TRAIN_FILE:-"${DATA_DIR}/train_mix_fewshot0.05_plus_btasks.jsonl"}
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-"omnimed_isic_btasks_n${N_SAMPLES}_t${TEMPERATURE}_v0_mixed"}
...
PYTHONPATH="${EASYR1_ROOT}/Comparative-R1/verl_patches:${EASYR1_ROOT}:${PYTHONPATH}" python3 -m verl.trainer.main \
  config="${CONFIG}" \
